...
async function fetchCargarCanales() {
  try {
    ...
    const response = await fetch('https://raw.githubusercontent.com/Navezjt/CNTV/main/assets/data/canalesRespaldo.json?token=GHSAT0AAAAAACQ6S3F7AHBWDW26TT2LS5YMZQ5WAKA');
